<template>
    <v-app>
        <v-app-bar app color="primary" dark>
            ...
            <v-toolbar-title>장치 관리 페이지</v-toolbar-title>
        </v-app-bar>
                ...
                <v-list>
                    <v-list-item>
                        <v-list-item-content>
                            ...
                            <v-list-item-title class="title">풀다운 메뉴</v-list-item-title>
...
export default {
  ...
  data() {     
      ...
      bDrawer: false,
      items: [
        { text: '메인 콘솔', icon: 'mdi-console', to:'/'},
        { text: '사이트 소개', icon: 'mdi-star', to:'/about'},
        { text: '간단 메뉴얼', icon: 'mdi-book', to:'/manual' },
        { text: '회사 정보', icon: 'mdi-information',to:'/information' },
      ],
      }
  }
};
